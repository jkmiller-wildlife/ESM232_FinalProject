...
F2 = 0.0
F3 = 0.0
F4 = 5.25*0.6 # 1156/220 # 5.25 eggs per adult, M to F ratio of 0.6 (3 males to 2 females). represents number eggs per female; adjust for diff sex ratios
...
p_adult = 1-75/100 # Adult survivorship, assume 75% make it; Adjust this value as needed.
...
n_years = 15
fert_snpl = c(F1,F2,F3,F4)
surv_snpl = c(p_egg,p_chick,p_fledge,p_adult)
K = 500 # VAFB Carrying capacity, based on Recover Goals; lookup actual value and adjust
