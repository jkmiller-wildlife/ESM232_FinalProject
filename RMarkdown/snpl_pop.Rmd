...
snpl_pop3=snpl_pop3(fert_snpl, surv_snpl, ini, n_years, K, predatorpop_matrix, area) # Test purpose
...
### CODE BELOW DOES NOT WORK. JUST LEFT IT THERE JUST IN CASE.
```{r}
### This does not work: When predation is decided by = n of predator * n of predation
